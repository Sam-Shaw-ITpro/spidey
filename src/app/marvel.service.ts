...
export class MarvelService {
  ...
  getAllSpidermanComicsMethod(): Observable<AllComicsfromApi> {
    return this.http.get<AllComicsfromApi>(`https://gateway.marvel.com:443/v1/public/comics?characters=1016825&apikey=6918d3b162edb8a846c8954d776e325c&ts=12121212&hash=7a29c937f783447960add3e3ac6b0d42`, httpOptions);
  }
